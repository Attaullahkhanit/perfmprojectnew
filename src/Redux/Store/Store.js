import {receivedOrdersList}  from "../Reducers/ReceivedOrdersListReducer";
...
const allReducers = combineReducers({regUsersListReducer, alcholicPerfumesReducer, nonAlcholicPerfumeReducer, receivedOrdersList });
